...
@IsNodeHandler
@Component
public class PromptNode3Handler extends Handler {
    @Override
    public void handleNode(Node node) {
        ...
        String temprature = node.getData().getStringProperty("temprature").toString();
        AgentInterface agent  = (AgentInterface) node.getData().getProperties().get("output");
        try {
