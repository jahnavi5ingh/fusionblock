...
@IsNodeHandler
@Component
public class UpdatePoints extends Fusion360Handler {
    ...
    public void handleNode(Node node) {
       //get in props count, xrangeLow, high,yrange low,high ,zrange low, high where low and high values are in same string separated by : in xrange...
        ...
        String field = (String) node.getData().getProperties().get("field");
        ...
        switch (field) {
            case "x":
                ...
                for (Point point : points) {
                    Point newPoint = point;
                        ...
                        e.setVariable("i", i);
                        newPoint.setX((float)e.evaluate());
            ...
            case "y":
                ...
                for (Point point : points) {
                    ...
                    e.setVariable("z", point.getZ());
                    e.setVariable("i", i);
                    newPoint.setY((float)e.evaluate());
                    newPoints.add(newPoint);
                    i++;
                }
                break;
            case "z":
                ...
                for (Point point : points) {
                    ...
                    e.setVariable("z", point.getZ());
                    e.setVariable("i", i);
                    newPoint.setZ((float)e.evaluate());
                    newPoints.add(newPoint);
                    i++;
                }
                break;
